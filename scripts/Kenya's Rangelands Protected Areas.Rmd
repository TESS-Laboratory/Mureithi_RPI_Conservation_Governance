...
# A better scientific plot showing the mean and standard deviation
ggplot(All.Trends.Summary, aes(x = reorder(Area, MeanSlope), y = MeanSlope)) +
  ...
  # Map the color aesthetic to a new variable to create a legend
  geom_point(aes(color = "Mean Slope"), size = 3, fill = "steelblue", shape = 21) +
  
  # Add the dashed line at zero
  ...
  labs(
    ...
    x = "Area",
    y = "Mean Slope",
    color = "Legend"  # Set the title for the legend
  ) +
  theme_minimal() +
