...
Actual.GPP <- rast("RPI Datasets (GuyLomax)/actual_gpp_ea_v2.tif")

Potential.GPP <- rast("RPI Datasets (GuyLomax)/potential_gpp_ea_v2.tif")

RPI <- rast("RPI Datasets (GuyLomax)/rpi_ea_v2.tif")
```
