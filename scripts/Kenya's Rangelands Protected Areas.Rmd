...
Combined.Slope.Maps <- tmap_arrange(
  ...
  ncol = 2 # The plots will be arranged into two columns automatically
)
...
# Switching to static plot mode for publication
tmap_mode("plot")

# Arranging the individual maps and store the result in a variable
Combined.RPI.Maps.After.Filtering <- tmap_arrange(
  tm_shape(Amboseli.RPI.Mean.Filtered.1) +
    tm_raster(
      col.scale = tm_scale_continuous(
        values = "viridis",
        # Use a fixed range for consistent colors
        limits = c(0, 1)
      ),
      outliers.trunc = "limits", # Truncate outlier values to fit the scale
      col.legend = tm_legend(title = "Amboseli Mean RPI (R² ≥ 0.1)", reverse = TRUE)
    ),
  ...
  tm_shape(TsavoEast.RPI.Mean.Filtered.1) +
    tm_raster(
      ...
      outliers.trunc = "limits",
      col.legend = tm_legend(title = "Tsavo East Mean RPI (R² ≥ 0.1)", reverse = TRUE)
    ),
  ...
  tm_shape(TsavoWest.RPI.Mean.Filtered.1) +
    tm_raster(
      ...
      outliers.trunc = "limits",
      col.legend = tm_legend(title = "Tsavo West Mean RPI (R² ≥ 0.1)", reverse = TRUE)
    ),
  ...
  tm_shape(AET.AllZones.RPI.Mean.Filtered.1) +
    tm_raster(
      ...
      outliers.trunc = "limits",
      col.legend = tm_legend(title = "AET All Zones Mean RPI (R² ≥ 0.1)", reverse = TRUE)
    ),
  ...
  tm_shape(Tsavo.AllZones.RPI.Mean.Filtered.1) +
    tm_raster(
      ...
      outliers.trunc = "limits",
      col.legend = tm_legend(title = "Tsavo All Zones Mean RPI (R² ≥ 0.1)", reverse = TRUE)
    ),
  ...
  tm_shape(Tsavo.Ranches.RPI.Mean.Filtered.1) +
    tm_raster(
      ...
      outliers.trunc = "limits",
      col.legend = tm_legend(title = "Tsavo Ranches Mean RPI (R² ≥ 0.1)", reverse = TRUE)
    ),
  ...
  tm_shape(Tsavo.SettledAreas.RPI.Mean.Filtered.1) +
    tm_raster(
      ...
      outliers.trunc = "limits",
      col.legend = tm_legend(title = "Tsavo Settled Areas Mean RPI (R² ≥ 0.1)", reverse = TRUE)
    ),
  ...
  tm_shape(AET.Conservancies.RPI.Mean.Filtered.1) +
    tm_raster(
      ...
      outliers.trunc = "limits",
      col.legend = tm_legend(title = "AET Conservancies Mean RPI (R² ≥ 0.1)", reverse = TRUE)
    ),
  ...
  tm_shape(AET.Buffers.RPI.Mean.Filtered.1) +
    tm_raster(
      ...
      outliers.trunc = "limits",
      col.legend = tm_legend(title = "AET Buffers Mean RPI (R² ≥ 0.1)", reverse = TRUE)
    ),

  ncol = 3 # Arrange into 3 columns
)
