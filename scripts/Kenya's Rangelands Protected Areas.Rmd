...
Amboseli.Values.RPI.Rsquare.Plot <- ggplot(Amboseli.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
...
TsavoEast.Values.RPI.Rsquare.Plot <- ggplot(TsavoEast.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
...
TsavoWest.Values.RPI.Rsquare.Plot <- ggplot(TsavoWest.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
...
AET.Conservancies.Values.RPI.Rsquare.Plot <- ggplot(AET.Conservancies.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
    title = "RPI vs R²: AET.Conservancies",
    x = expression(R^2 ~ "(Model Performance)"),
    y = "Mean RPI",
    color = "RPI Value"
  ) +
...
AET.Buffers.Values.RPI.Rsquare.Plot <- ggplot(AET.Buffers.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
    title = "RPI vs R²: AET.Buffers",
    x = expression(R^2 ~ "(Model Performance)"),
    y = "Mean RPI",
    color = "RPI Value"
  ) +
...
AET.AllZones.Values.RPI.Rsquare.Plot <- ggplot(AET.AllZones.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
