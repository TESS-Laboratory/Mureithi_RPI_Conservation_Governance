...
ggplot(Amboseli.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
...
ggplot(TsavoEast.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
    title = "RPI vs R²: Amboseli",
...
ggplot(TsavoWest.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
    title = "RPI vs R²: Amboseli",
...
ggplot(AET.Conservancies.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
    title = "RPI vs R²: Amboseli",
...
ggplot(AET.Buffers.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
    title = "RPI vs R²: Amboseli",
...
ggplot(AET.AllZones.Values.RPI.Rsquare, aes(x = RSQ, y = RPI, color = RPI)) +
  geom_point(alpha = 0.4, size = 1) +
  scale_color_viridis_c(option = "D") +
  labs(
    title = "RPI vs R²: Amboseli",
