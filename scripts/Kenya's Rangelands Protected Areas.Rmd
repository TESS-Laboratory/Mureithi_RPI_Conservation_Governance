...
pacman::p_load(sf, terra, tidyverse, tidyterra, colorspace, ggrepel, patchwork, tmap, trend, slider)
```
...
tm_shape(Amboseli.Slope.Raster) +
  tm_raster(
    ...
    col.legend = tm_legend(title = "Theil–Sen Slope")
  ) +
...
Primary.Concern.Areas.RPI.Trends.5yr <- Primary.Concern.Areas.RPI.Trends %>%
  ...
  # 2. Visualising 5-Year Rolling Mean RPI Trends for Primary Concern Areas
