...
RSQ.Low.Performance.Kenya <- RSQ.Kenya <= 0.1

tmap_mode("view")
tm_shape(RSQ.Low.Performance.Kenya) +
  tm_raster(
    style = "cat", palette = c("transparent", "red"),
    title = "R² ≤ 0.1", labels = c("Good", "Poor")
  ) +
  tm_shape(Kenya.Admin.Boundary) +
  tm_borders(col = "black") +
  tm_layout(
    main.title = "Pixels with R² ≤ 0.1 (Kenya)",
    legend.outside = TRUE
  )
```
