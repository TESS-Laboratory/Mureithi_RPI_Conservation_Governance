...
ggplot() +
  # geom_sf(data = Kenya.Admin.Boundary) +
  geom_sf(data = Amboseli, aes(fill = "Forest Areas"), color = 'black', linewidth = 0.1, alpha = 0.5) +
  geom_sf(data = ChyuluHills, aes(fill = "Forest Areas"), color = 'black', linewidth = 0.1, alpha = 0.5) +
  geom_sf(data = TsavoEast, aes(fill = "Forest Areas"), color = 'black', linewidth = 0.1, alpha = 0.5) +
  geom_sf(data = TsavoWest, aes(fill = "Forest Areas"), color = 'black', linewidth = 0.1, alpha = 0.5) +
  geom_sf(data = NgaiNdethia, aes(fill = "Forest Areas"), color = 'black', linewidth = 0.1, alpha = 0.5) +
