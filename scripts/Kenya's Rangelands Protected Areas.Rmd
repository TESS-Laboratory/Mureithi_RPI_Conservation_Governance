...
Amboseli.Rolling <- Amboseli.RPI.Visual %>%
  group_by(Year) %>%
  summarise(Mean_RPI = mean(RPI_value, na.rm = TRUE)) %>%
  arrange(Year) %>%
...
ggplot(Amboseli.RPI.Visual, aes(x = factor(Year), y = RPI_value)) +
  geom_violin(fill = "lightblue", color = "black", alpha = 0.7) +
  geom_line(data = Amboseli.Rolling, aes(x = Year, y = RollingMean5, group = 1),
            color = "red", linewidth = 1) +
  geom_point(data = Amboseli.Rolling, aes(x = Year, y = RollingMean5),
             color = "red", size = 2) +
  labs(title = "RPI Distribution in Amboseli",
       x = "Year", y = "RPI Value") +
  theme_beautiful()
```
...
TsavoEast.Rolling <- TsavoEast.RPI.Visual %>%
  group_by(Year) %>%
  summarise(Mean_RPI = mean(RPI_value, na.rm = TRUE)) %>%
  arrange(Year) %>%
  mutate(RollingMean5 = rollmean(Mean_RPI, k = 5, fill = NA, align = "center"))
...
ggplot(TsavoEast.RPI.Visual, aes(x = factor(Year), y = RPI_value)) +
  geom_violin(fill = "lightblue", color = "black", alpha = 0.7) +
  geom_line(data = TsavoEast.Rolling, aes(x = Year, y = RollingMean5, group = 1),
            color = "red", linewidth = 1) +
  geom_point(data = TsavoEast.Rolling, aes(x = Year, y = RollingMean5),
             color = "red", size = 2) +
  labs(title = "RPI Distribution in TsavoEast",
       x = "Year", y = "RPI Value") +
  theme_beautiful()
```
...
TsavoWest.Rolling <- TsavoWest.RPI.Visual %>%
  group_by(Year) %>%
  summarise(Mean_RPI = mean(RPI_value, na.rm = TRUE)) %>%
  arrange(Year) %>%
  mutate(RollingMean5 = rollmean(Mean_RPI, k = 5, fill = NA, align = "center"))
...
ggplot(TsavoWest.RPI.Visual, aes(x = factor(Year), y = RPI_value)) +
  geom_violin(fill = "lightblue", color = "black", alpha = 0.7) +
  geom_line(data = TsavoWest.Rolling, aes(x = Year, y = RollingMean5, group = 1),
            color = "red", linewidth = 1) +
  geom_point(data = TsavoWest.Rolling, aes(x = Year, y = RollingMean5),
             color = "red", size = 2) +
  labs(title = "RPI Distribution in TsavoWest",
       x = "Year", y = "RPI Value") +
  theme_beautiful()
```
...
Tsavo.Ranches.Rolling <- Tsavo.Ranches.RPI.Visual %>%
  group_by(Year) %>%
  summarise(Mean_RPI = mean(RPI_value, na.rm = TRUE)) %>%
  arrange(Year) %>%
  mutate(RollingMean5 = rollmean(Mean_RPI, k = 5, fill = NA, align = "center"))
...
ggplot(Tsavo.Ranches.RPI.Visual, aes(x = factor(Year), y = RPI_value)) +
  geom_violin(fill = "lightblue", color = "black", alpha = 0.7) +
  geom_line(data = Tsavo.Ranches.Rolling, aes(x = Year, y = RollingMean5, group = 1),
            color = "red", linewidth = 1) +
  geom_point(data = Tsavo.Ranches.Rolling, aes(x = Year, y = RollingMean5),
             color = "red", size = 2) +
  labs(title = "RPI Distribution in Tsavo.Ranches",
       x = "Year", y = "RPI Value") +
  theme_beautiful()
```
...
Tsavo.SettledAreas.Rolling <- Tsavo.SettledAreas.RPI.Visual %>%
  group_by(Year) %>%
  summarise(Mean_RPI = mean(RPI_value, na.rm = TRUE)) %>%
  arrange(Year) %>%
  mutate(RollingMean5 = rollmean(Mean_RPI, k = 5, fill = NA, align = "center"))
...
ggplot(Tsavo.SettledAreas.RPI.Visual, aes(x = factor(Year), y = RPI_value)) +
  geom_violin(fill = "lightblue", color = "black", alpha = 0.7) +
  geom_line(data = Tsavo.SettledAreas.Rolling, aes(x = Year, y = RollingMean5, group = 1),
            color = "red", linewidth = 1) +
  geom_point(data = Tsavo.SettledAreas.Rolling, aes(x = Year, y = RollingMean5),
             color = "red", size = 2) +
  labs(title = "RPI Distribution in Tsavo.SettledAreas",
       x = "Year", y = "RPI Value") +
  theme_beautiful()
```
...
Tsavo.AllZones.Rolling <- Tsavo.AllZones.RPI.Visual %>%
  group_by(Year) %>%
  summarise(Mean_RPI = mean(RPI_value, na.rm = TRUE)) %>%
  arrange(Year) %>%
  mutate(RollingMean5 = rollmean(Mean_RPI, k = 5, fill = NA, align = "center"))
...
ggplot(Tsavo.AllZones.RPI.Visual, aes(x = factor(Year), y = RPI_value)) +
  geom_violin(fill = "lightblue", color = "black", alpha = 0.7) +
  geom_line(data = Tsavo.AllZones.Rolling, aes(x = Year, y = RollingMean5, group = 1),
            color = "red", linewidth = 1) +
  geom_point(data = Tsavo.AllZones.Rolling, aes(x = Year, y = RollingMean5),
             color = "red", size = 2) +
  labs(title = "RPI Distribution in Tsavo.AllZones",
       x = "Year", y = "RPI Value") +
  theme_beautiful()
```
...
AET.Conservancies.Rolling <- AET.Conservancies.RPI.Visual %>%
  group_by(Year) %>%
  summarise(Mean_RPI = mean(RPI_value, na.rm = TRUE)) %>%
  arrange(Year) %>%
  mutate(RollingMean5 = rollmean(Mean_RPI, k = 5, fill = NA, align = "center"))
...
ggplot(AET.Conservancies.RPI.Visual, aes(x = factor(Year), y = RPI_value)) +
  geom_violin(fill = "lightblue", color = "black", alpha = 0.7) +
  geom_line(data = AET.Conservancies.Rolling, aes(x = Year, y = RollingMean5, group = 1),
            color = "red", linewidth = 1) +
  geom_point(data = AET.Conservancies.Rolling, aes(x = Year, y = RollingMean5),
             color = "red", size = 2) +
  labs(title = "RPI Distribution in AET.Conservancies",
       x = "Year", y = "RPI Value") +
  theme_beautiful()
```
...
AET.Buffers.Rolling <- AET.Buffers.RPI.Visual %>%
  group_by(Year) %>%
  summarise(Mean_RPI = mean(RPI_value, na.rm = TRUE)) %>%
  arrange(Year) %>%
  mutate(RollingMean5 = rollmean(Mean_RPI, k = 5, fill = NA, align = "center"))
...
ggplot(AET.Buffers.RPI.Visual, aes(x = factor(Year), y = RPI_value)) +
  geom_violin(fill = "lightblue", color = "black", alpha = 0.7) +
  geom_line(data = AET.Buffers.Rolling, aes(x = Year, y = RollingMean5, group = 1),
            color = "red", linewidth = 1) +
  geom_point(data = AET.Buffers.Rolling, aes(x = Year, y = RollingMean5),
             color = "red", size = 2) +
  labs(title = "RPI Distribution in AET.Buffers",
       x = "Year", y = "RPI Value") +
  theme_beautiful()
```
...
AET.AllZones.Rolling <- AET.AllZones.RPI.Visual %>%
  group_by(Year) %>%
  summarise(Mean_RPI = mean(RPI_value, na.rm = TRUE)) %>%
  arrange(Year) %>%
  mutate(RollingMean5 = rollmean(Mean_RPI, k = 5, fill = NA, align = "center"))
...
ggplot(AET.AllZones.RPI.Visual, aes(x = factor(Year), y = RPI_value)) +
  geom_violin(fill = "lightblue", color = "black", alpha = 0.7) +
  geom_line(data = AET.AllZones.Rolling, aes(x = Year, y = RollingMean5, group = 1),
            color = "red", linewidth = 1) +
  geom_point(data = AET.AllZones.Rolling, aes(x = Year, y = RollingMean5),
             color = "red", size = 2) +
  labs(title = "RPI Distribution in AET.AllZones",
       x = "Year", y = "RPI Value") +
  theme_beautiful()
```
...
```{r}
# Make sure Area is a factor ordered by mean slope for consistent plotting
All.Pixel.Slopes <- All.Pixel.Slopes %>%
  group_by(Area) %>%
  mutate(MeanSlopeArea = mean(Slope, na.rm = TRUE)) %>%
  ungroup() %>%
  mutate(Area = factor(Area, levels = unique(All.Pixel.Slopes$Area[order(All.Pixel.Slopes$Slope)])))

# Ridgeline plot of pixel-level slopes per area
Ridgeline.Plot <- ggplot(All.Pixel.Slopes, aes(x = Slope, y = Area, fill = ..x..)) +
  geom_density_ridges_gradient(scale = 3, rel_min_height = 0.01, color = "black") +
  geom_vline(xintercept = 0, linetype = "dashed", color = "red", size = 1) +  # zero reference
  scale_fill_viridis_c(name = "Slope", option = "C") +
  labs(
